...
public partial class Changedwagerdetail
{
    public int IdChangedWager { get; set; }
    ...
    public virtual Changedwagerheader IdChangedWagerNavigation { get; set; } = null!;
}
